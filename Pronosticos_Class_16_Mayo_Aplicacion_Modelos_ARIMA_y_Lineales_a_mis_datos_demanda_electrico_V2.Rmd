...
new_formula <- as.formula(paste("Demanded_Gas + Poblacion_en_Mexico + PIB_Millones_de_Dolares",
                               collapse = " + "))
...
##### Diagnostico de residuales Demanda_electrico con Poblacion_en_Mexico 
