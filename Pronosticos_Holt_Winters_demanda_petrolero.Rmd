---
title: "Pronosticos_Holt_Winters_demanda_petrolero"
author: "Sergi"
date: "2023-02-27"
...
```{r}
Demanda_petrolero_importado.ts<- ts(Demanda_petrolero_importado$Demanded_Gas, frequency = 12, start =c(2005,1), end =c(2022,9))
head(Demanda_petrolero_importado.ts)
summary(Demanda_petrolero_importado.ts)
...
```{r}
Demanda_petrolero_SES <- ses(Demanda_petrolero_importado.ts, alpha=0.2, na.rm = TRUE)
#head(Demanda_petrolero_SES)
#tail(Demanda_petrolero_SES)
#typeof(Demanda_petrolero_SES)
```
