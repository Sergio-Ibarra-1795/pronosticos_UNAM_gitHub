...
Calculemos los valores de la data, ahora restando "el componente de trend" 
```{r}
Demanda_electrico_SIN_Season_ni_Trend <- Demanda_electrico_importado.ts - Demanda_electricoDC$trend
Demanda_electrico_SIN_Season_ni_Trend
plot.ts(Demanda_electrico_SIN_Season_ni_Trend, main = "Demanda electrico sin componente de seasonalidad ni de trend", col="pink")
```
...
```{r}
plot(Demanda_electrico_importado.ts, col = "red", main = "Demanda electrico Holt-winters ")
