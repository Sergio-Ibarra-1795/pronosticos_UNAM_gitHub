...
#### Se lleva a cabo el testeo del 'modelo lineal generalizado simple'  haciendo la predición de los datos de test 
...
#### Intentemos un 'modelo lineal simple' de Demanda_electrico ahora como función de la Temperatura 
