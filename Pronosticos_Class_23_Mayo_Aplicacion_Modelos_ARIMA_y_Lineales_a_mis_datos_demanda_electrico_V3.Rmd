...
```{r}
plot(Demanda_electrico_importado.ts_V3, col = "violet", main = " Demanda de Gas Natural en sector eléctrico en México (Datos mensuales de 2005 a 2022)", cex.main = 0.9 , ylab="Demanda de gas [MMpcd]", xlab ="Tiempo")
...
acf_demanda_electrico_sin_diferencia_V3 <- Acf(Demanda_electrico_importado.ts_V3, lag.max = 100, ci.type = "ma", main="ACF para los datos de Demanda de gas en sector eléctrico en México")
acf_demanda_electrico_sin_diferencia_V3


pacf_demanda_electrico_sin_diferencia_V3 <- Pacf(Demanda_electrico_importado.ts_V3, lag.max = 100, ci.type = "ma", main="PACF para los datos de Demanda de gas en sector eléctrico en México")
pacf_demanda_electrico_sin_diferencia_V3
...
acf_demanda_electrico_diferencia1_V3 <- Acf(Demanda_electrico_diferencia1_V3, lag.max = 100, ci.type = "ma")
acf_demanda_electrico_diferencia1_V3


pacf_demanda_electrico_diferencia1_V3 <- Pacf(Demanda_electrico_diferencia1_V3, lag.max = 100, ci.type = "ma")
pacf_demanda_electrico_diferencia1_V3
```
