...
legend("bottomright", legend = c("Demanda electrico 'original'con SMA", "Demanda electrico ´original´"), col = c("green", "red"), lty = 1)
```



#### Wighted Moving Average (WMA)
...
```{r}
plot(Demanda_electrico_ts_WMA, col = "purple", main = "Demanda electrico 'original'con SMA ")
lines(Demanda_electrico_importado.ts, col="red")
