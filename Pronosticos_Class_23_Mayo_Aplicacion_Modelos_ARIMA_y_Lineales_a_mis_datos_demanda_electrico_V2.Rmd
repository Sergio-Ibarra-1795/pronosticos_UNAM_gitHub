...
```{r}
plot(Demanda_electrico_importado.ts_V2, col = "red", main = "Demanda electrico 'original'_V2 ")
...
SARIMA_1_1_1_Demanda_electrico_V2 <- astsa::sarima(Demanda_electrico_sin_differencia_train_V2, p=1, d=1, q=1)

# Print the model summary
summary(SARIMA_1_1_1_Demanda_electrico_V2)
...
pred_SARIMA_1_1_1_Demanda_electrico_V2 <- sarima.for(Demanda_electrico_sin_differencia_train_V2, n.ahead=12,1,1,1)
